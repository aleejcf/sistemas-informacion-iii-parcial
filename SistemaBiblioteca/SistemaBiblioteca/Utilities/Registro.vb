...
''' <summary>Bitácora en archivo. Los detalles técnicos de un error se guardan
''' aquí; al usuario solo se le muestra un mensaje entendible (recomendación
''' OWASP: no exponer información interna en pantalla).</summary>
Public Class Registro
    ...
    Public Shared ReadOnly Property RutaArchivo As String
        Get
            ...
            Return Path.Combine(carpeta, $"alejandria_{DateTime.Now:yyyy-MM-dd}.log")
        End Get
    End Property
        ...
        Try
            SyncLock Candado
                File.AppendAllText(RutaArchivo,
                    $"{DateTime.Now:yyyy-MM-dd HH:mm:ss} [{nivel}] [{Sesion.NombreUsuario}] {mensaje}{Environment.NewLine}")
            End SyncLock
        Catch
