...
''' <summary>Reglas de validación propias de Alejandría. Las que comparten los
''' tres sistemas —correo, usuario, contraseña— viven en Comun.Validador; aquí
''' solo se reenvían para que el resto del código no tenga que escribir "Comun."
