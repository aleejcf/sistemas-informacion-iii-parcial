...
-- ============================================================================
--  `usuario` guarda a quien OPERA el sistema (personal de la aerolínea), que no
--  es lo mismo que `pasajero`, quien VIAJA. Por eso son dos tablas distintas.
--
...
--  queda como Administrador y los siguientes como Agentes.
--
--  Idempotente.
-- ============================================================================
...
CREATE TABLE dbo.usuario (
    ...
    CONSTRAINT CK_usuario_rol CHECK (rol IN ('Administrador', 'Agente'))
);
GO
...
-- Procedimiento de consulta de la bitácora con filtros opcionales
...
PRINT 'ALAS · 04_sistema_login.sql aplicado correctamente.';
GO
