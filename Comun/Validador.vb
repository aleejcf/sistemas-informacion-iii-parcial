...
''' <summary>Reglas de validación puras, iguales en los tres sistemas: no tocan la
''' base de datos ni la interfaz, por eso se pueden probar con pruebas unitarias.
'''
''' Lo que es específico de cada sistema —códigos de vuelo, ISBN, plazos de
''' préstamo— se queda en el Validador propio de cada proyecto, que reenvía aquí
''' lo que sí comparten.</summary>
